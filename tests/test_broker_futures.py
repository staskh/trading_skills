# ABOUTME: Tests for the futures broker module: static registry and dynamic exchange detection.
# ABOUTME: Covers FUTURES_EXCHANGE, futures_yahoo_ticker, _pick_future_exchange, and option helpers.

from types import SimpleNamespace

from trading_skills.broker.futures import (
    FUTURES_EXCHANGE,
    _pick_future_exchange,
    futures_yahoo_ticker,
)
