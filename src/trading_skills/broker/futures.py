# ABOUTME: Centralized futures symbol registry and IB contract helpers.
# ABOUTME: Provides static exchange/yahoo mappings and dynamic IB-based contract resolution.
